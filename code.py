...
#constants for blinky light mode
BRIGHTNESS = 50  # CONFIGURABLE: LED brightness, 0 (off) to 255 (max)
...
class FakePILImage: #used in the blinky lights portion of the code
...
def ButtonTask(self):
    ...
    self.send(pyRTOS.Message(SENT_MODE, self, "display_task", mode))
    while True:
